...
// console.log(parseInt(system.Jupiter.satellites) + parseInt(system.Saturn.satellites) + parseInt(system.Uranus.satellites) + parseInt(system.Neptune.satellites));

if(typeof system.Mercury.radiusp == 'string'){
  console.log(typeof system.Mercury.radiuse);
  console.log(system.Mercury.radiusp);
  parseInt(system.Mercury.radiusp);
